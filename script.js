var cartaPaulo = {
    ...
    imagem: "https://i.postimg.cc/7ZFjXJTK/seiya.jpg",
    atributos: {
        ataque: 80,
        defesa: 60,
        magia: 90
...
var cartaRafa = {
    nome: "Bulbasaur",
    imagem: "https://i.postimg.cc/BQWzyChR/bulbasaur.png",
    atributos: {
        ataque: 70,
        defesa: 65,
        magia: 85
...
var cartaGui = {
    ...
    imagem: "https://i.postimg.cc/5ybwCTgy/Darth-Vader.jpg",
    atributos: {
        ataque: 88,
        defesa: 62,
        magia: 90
...
function jogar() {
    ...
    if (cartaJogador.atributos[atributoSelecionado] > cartaMaquina.atributos[atributoSelecionado]) {
        ...
        pontosJogador++
    } else if (cartaJogador.atributos[atributoSelecionado] < cartaMaquina.atributos[atributoSelecionado]) {        htmlResultado = '<p class="resultado-final">Perdeu</p>'
         pontosMaquina++
    } else {
